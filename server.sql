...
('Alice Johnson', 'Manager', 'alice@company.com', '123-456-7891'),
('Bob Williams', 'Stock Clerk', 'bob@company.com', '123-456-7892'),
('Charlie Davis', 'Sales Associate', 'charlie@company.com', '123-456-7893');

-- Insert sample suppliers
INSERT INTO Suppliers (SupplierName, ContactName, ContactEmail, PhoneNumber, Address) VALUES
('ABC Electronics', 'John Doe', 'john@abc.com', '123-456-7890', '1234 Electronics St, NY'),
('XYZ Gadgets', 'Jane Smith', 'jane@xyz.com', '987-654-3210', '5678 Gadget Ave, CA');
